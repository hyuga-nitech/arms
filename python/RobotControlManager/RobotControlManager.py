            ...
            while True:
                ...
                if isMoving:
                    ...
                    if Practice == 1:
                        ...
                        time2ratio = round((time.perf_counter() - taskStartTime)%switchTime)
                        if time2ratio <= switchTime/2:
                            xratio      = [1-time2ratio*(2/switchTime),1-time2ratio*(2/switchTime),time2ratio*(2/switchTime),time2ratio*(2/switchTime)]
                            mikataratio = [time2ratio*(2/switchTime),1-time2ratio*(2/switchTime)]
                        else:
                            time2ratio = switchTime - time2ratio
                            xratio      = [1-time2ratio*(2/switchTime),1-time2ratio*(2/switchTime),time2ratio*(2/switchTime),time2ratio*(2/switchTime)]
                            mikataratio = [time2ratio*(2/switchTime),1-time2ratio*(2/switchTime)]
