...
class OptiTrackStreamingManager:
    ...
    def __init__(self,defaultRigidBodyNum: int = 2): #RigidBody1 is for xArm , RigidBody2 is for mikataArm. if you need some additional RigidBodys , use after RigidBody3.
